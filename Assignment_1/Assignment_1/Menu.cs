        ...
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                if (option == '1')
                {
                    ...
                    obj1.create_Profile(name, id, sem, dept, uni, cgpa, present, args[0]);
                }
                else if (option == '2')
                {
                    do
                ...
                else if (option == '3')
                {
                    Console.WriteLine("please enter id in format as 001,002....");
                    id = Console.ReadLine();
                    obj1.delete_Record(id, args[0]);
                }
                else if (option == '4')
                {
                    obj1.find_Top3(args[0]);
                }
                else if (option == '5')
                {
                    Console.WriteLine("please enter dept in format as bse,bce,bcs....");
                    ...
                    Console.WriteLine("please enter semester in format as 1st,2nd,3rd,4th...");
                    sem = Console.ReadLine();
                    obj1.mark_Attendance(dept, sem, args[0]);
                }
                else if (option == '6')
                {
                    Console.WriteLine("please enter dept in format as bse,bce,bcs....");
                    ...
                    Console.WriteLine("please enter semester in format as 1st,2nd,3rd,4th...");
                    sem = Console.ReadLine();
                    obj1.view_Attendance(dept, sem, args[0]);
                }
                else if (option == 'e')
                {
